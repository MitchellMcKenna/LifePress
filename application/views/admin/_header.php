    ...
    <?php if (isset($this->auth)): ?>
        <div id="nav_container"<?php if (!$this->auth->is_logged()): ?> class="login"<?php endif; ?>>
            <?php if ($this->auth->is_logged()): ?>
                <ul id="nav">
                    <li id="nav_dashboard"<?php if ($this->lifepress->is_current_page('')): ?> class="current_item"<?php endif; ?>><a href="<?php echo $this->config->item('base_url')?>admin">Dashboard</a></li>
                    <li<?php if ($this->lifepress->is_current_page('Write')): ?> class="current_item"<?php endif; ?>><a href="<?php echo $this->config->item('base_url')?>admin/write">Write</a></li>
                    <li<?php if ($this->lifepress->is_current_page('Items')): ?> class="current_item"<?php endif; ?>><a href="<?php echo $this->config->item('base_url')?>admin/items">Items</a></li>
                    <li<?php if ($this->lifepress->is_current_page('Feeds')): ?> class="current_item"<?php endif; ?>><a href="<?php echo $this->config->item('base_url')?>admin/feeds">Feeds</a></li>
                    <li<?php if ($this->lifepress->is_current_page('Options')): ?> class="current_item"<?php endif; ?>><a href="<?php echo $this->config->item('base_url')?>admin/options">Options</a></li>
                </ul>
            <?php endif; ?>
        </div>
        <?php else: ?>
