<div id="main_content">
    ...
    <form action="" method="post" class="generic">
        <p>
            ...
            <span class="input_explain">Input the administrator email address</span>
        </p>

        <?php if (!isset($success)): ?>
            <div class="buttons">
                <button type="submit"><img src="<?php echo $this->config->item('base_url')?>public/images/system/icons/silk/key.png" alt=""/> Reset Password</button>
            </div>
        <?php endif; ?>
    </form>
</div>
