...
<div id="side_content">
    <div class="buttons">
        <a href="<?php echo $this->config->item('base_url')?>admin/items/fetch" class="positive"><img src="<?php echo $this->config->item('base_url')?>public/images/system/icons/silk/add.png" alt="" />Fetch New Items Now</a>
    </div>
    ...
    <ul class="generic active_feeds">
        <li style="background: transparent url(/favicon.ico) 0 center no-repeat;">
            <?php if (isset($site) && $site == 'lifepress'): ?>
                LifePress
            <?php else: ?>
                <a href="<?php echo $this->config->item('base_url')?>admin/items/site/lifepress">LifePress</a>
            <?php endif; ?>
        </li>
